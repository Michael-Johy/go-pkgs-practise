...
type HelloWorldClient interface {
	SayHelloWorld(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error)
}
...
func (c *helloWorldClient) SayHelloWorld(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
...
type HelloWorldServer interface {
	SayHelloWorld(context.Context, *HelloRequest) (*HelloResponse, error)
...
func (UnimplementedHelloWorldServer) SayHelloWorld(context.Context, *HelloRequest) (*HelloResponse, error) {
...
func _HelloWorld_SayHelloWorld_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloWorldServer).SayHelloWorld(ctx, req.(*HelloRequest))
	}
